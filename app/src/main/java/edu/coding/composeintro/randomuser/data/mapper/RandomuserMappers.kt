package edu.coding.composeintro.randomuser.data.mapper

import edu.coding.composeintro.randomuser.data.local.db.RandomuserEntity
import edu.coding.composeintro.randomuser.data.remote.response.Coordinates
import edu.coding.composeintro.randomuser.data.remote.response.Dob
import edu.coding.composeintro.randomuser.data.remote.response.Id
import edu.coding.composeintro.randomuser.data.remote.response.Location
import edu.coding.composeintro.randomuser.data.remote.response.Login
...
import edu.coding.composeintro.randomuser.data.remote.response.RandomuserDTO
